...
echo -e  "Tools    : ToolsInstallerv1 
$white         
" |lolcat
echo -e  "Creadby  : Me.Alone404 $white   " 
|lolcat
echo -e  "Contact  : - $white " |lolcat
echo -e  
"_____________________________________________________________"
...
sleep 1
echo ""
echo -e $white"[#]> Terima Kasih 
Sudah Menggunakan Tools Kami Kimak:)..."
sleep 1
exit
}
...
echo -e "${y} cara menggunakan admin 
finder"
...
cd 
/data/data/com.termux/files/home/RED_HAWK/
php 
/data/data/com.termux/files/home/RED_HAWK/ 
RED_HAWK.php
...
bash 
/data/data/com.termux/files/home/Tool-X/sh 
install.aex

;;


6) echo "created by : Mr.Alone404" | 
lolcat
exit
;;

*) echo "sorry, Maaf Ya Boedjank, Pilihan 
